...
const Profile = () => {
  ...
  const adminItems = [
    { label: "Configurações da Empresa", icon: Settings, onClick: () => setCompanySettingsOpen(true) },
  ...
  return (
    <AppLayout showFab={false}>
      ...
      <CompanySettingsDialog open={companySettingsOpen} onOpenChange={setCompanySettingsOpen} />
    </AppLayout>
  );
};
